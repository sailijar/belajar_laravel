        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <div class="float-end"><a href="/dosen/form" class="btn btn-primary btn-sm"><i class="fa-solid fa-user-plus"></i> Tambah Data</a></div>
                            ...
                            @forelse ( $dosen as $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/dosen/edit/{{$data->id}}" class="btn btn-info btn-sm"><i class="bi bi-pencil-square"></i></a>
